...
//    std::cout << "type" << type << "Min  " << minVal << std::endl;
    ...
    if (dis) {
        ...
        double distance = real_edge / (2 * tan225) + 0.1;

        double position = (512 / 2 - (matchLoc.x + (templ.cols / 2)) )/ (double)templ.cols;
        ...
        marker.scale.z = 1.0;
        marker.color.a = 1.0;
        marker.color.r = (double)0.2/(double)type;
        marker.color.g = (double)0.4/(double)type;
        marker.color.b = (double)1.0/(double)type;
	...
	switch (type) {
        case 1:
            ...
            break;
        case 2:
            cout << "Avril Lavigne" << endl;
            break;
        case 3:
            cout << "ZHANG Guorong" << endl;
            break;
        case 4:
            cout << "Hou Yi" << endl;
            break;
        case 5:
            cout << "Bing Chang" << endl;
            break;
        default:
            break;
   	}
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle n("~");
    pub_cmd = n.advertise<visualization_msgs::Marker>("image_reconition_result", 2);

    // to be modified
    Mat original_templ1 = imread("/home/ros/ws/src/picture_sample/pic001.jpg");
    Mat original_templ2 = imread("/home/ros/ws/src/picture_sample/pic002.jpg");
    Mat original_templ3 = imread("/home/ros/ws/src/picture_sample/pic003.jpg");
    flip(original_templ3, original_templ3, 1);

    Mat original_templ4 = imread("/home/ros/ws/src/picture_sample/pic004.jpg");
    Mat original_templ5 = imread("/home/ros/ws/src/picture_sample/pic005.jpg");
    ...
    resize(original_templ2, templ2_2nd, Size(220, 220), 0, 0);
    resize(original_templ2, templ2_3rd, Size(200, 200), 0, 0);
    ...
    resize(original_templ5, templ5_1st, Size(180, 180), 0, 0);
